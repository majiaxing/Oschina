...
public class ZuiXinFragment extends BaseFragment {
    ...
    private TuijianAdapter zuiXinAdapter;
    ...
    protected void initData() {
        ...
        zuiXinAdapter=new TuijianAdapter(getContext(),mList);
        PullToRecycleView.setAdapter(zuiXinAdapter);
    }
    ...
    protected void loadData() {
        discoverModel.zuixin(String.valueOf(Index), new NetWorkCallBack() {
            @Override

...
public class BokeXiangqing extends BaseActivity implements NetWorkCallBack,View.OnClickListener{
    ...
    public void onSuccess(String xmlData) {
        ...
        xStream.alias("oschina",BokexiangqingBean.class);
        xStream.alias("blog", BokexiangqingBean.BlogBean.class);

        BokexiangqingBean hotspot = (BokexiangqingBean) xStream.fromXML(xmlData);
        Log.e("AAA","数据解析成功"+hotspot.toString());

        rurl = hotspot.getBlog().getUrl();
        Log.e("vvv","Url"+rurl);

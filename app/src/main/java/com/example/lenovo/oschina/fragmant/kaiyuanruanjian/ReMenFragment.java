...
import com.example.lenovo.oschina.adapter.kaiyuanruanjian.RemenAdapter;
...
public class ReMenFragment extends BaseFragment {
    ...
    private TuijianAdapter reMenAdapter;
    ...
    protected void initData() {
        ...
        reMenAdapter=new TuijianAdapter(getActivity().getApplication(),mList);
        PullToRecycleView.setAdapter(reMenAdapter);
    }
    ...
    protected void loadData() {
        discoverModel.remen(String.valueOf(Index), new NetWorkCallBack() {
            @Override
